...
const E_Switch = () => {
  ...
  return (
    <SafeAreaView style={[styles.container,{backgroundColor:isDarkMode?"black":"white"}]}>
      <TextInput
        style={[styles.input,textColor,{borderColor:isDarkMode?"white":"black"}]}
        value={name}
      ...
      <TextInput style={[styles.input,textColor,{borderColor:isDarkMode?"white":"black"}]} placeholder="email@example.com" />
      <TextInput
        style={[styles.input, styles.multilineText,textColor,{borderColor:isDarkMode?"white":"black"}]}
